...
// to make a small donation for some much needed updates to the center's facilities.
// Each business has assigned a representative to attend the event with a small donation.
...
ticketPriceTotal = runners.map(currentValue => currentValue.donation);
const ticketReducer = (accumulator, currentValue) => accumulator + currentValue;
console.log(`The grand total of donations is ${ticketPriceTotal.reduce(ticketReducer)}`);
